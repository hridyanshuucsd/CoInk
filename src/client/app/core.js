...
User writes “我需要根据地点, 显示空气质量”, names a place, and points to an empty area. Produce one html_widget there that uses that place in its API requests and displays the resulting air-quality information in large readable type.`,
  ...
  const I18N = {
    en: {
      ...
      aiTools: "AI tools",
      voice: "Voice",
      voiceTutor: "Start voice tutor",
      voiceStop: "Stop voice tutor",
      voiceConnecting: "Connecting voice tutor...",
      voiceConnected: "Voice tutor is listening",
      voiceStopped: "Voice tutor stopped",
      voiceUnavailable: "Voice tutor is unavailable",
      voiceError: "Voice tutor could not connect",
      grid: "Canvas grid",
